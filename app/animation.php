...
define('CRM_HOST', 'esco-crm.bitrix24.ua'); // your CRM domain name
define('CRM_PORT', '443'); // CRM server port
define('CRM_PATH', '/crm/configs/import/lead.php'); // CRM server REST service path

// CRM server authorization data
define('CRM_LOGIN', 'user229@esco.bizml.ru'); // login of a CRM user able to manage leads
define('CRM_PASSWORD', 'danger105361'); // password of a CRM user
